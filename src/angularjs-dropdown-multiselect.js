    ...
    function ($filter, $document, $compile, $parse) {
        ...
        return {
            ...
            template: function (element, attrs) {
                ...
                template += '<button type="button" class="dropdown-toggle" style="border: none; text-align: left; padding-right: 0;" ng-class="settings.buttonClasses" ng-click="toggleDropdown()">{{getButtonText()}}&nbsp;<span style="margin-left: 0;" class="caret"></span></button>';
